...
```json
{
  ...
  "data": {
    ...
    "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJyZWR3YW5oYXNhbmNzZUBnbWFpbC5jb20iLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3Njc0NzUwODEsImV4cCI6MTc2NzU2MTQ4MX0.LIDXRtLqFmErXv2hhmB4-e8VJM5L13qGURIv_r3m1k0"
  }
}
```
...
See README.md for setup and database configuration.
